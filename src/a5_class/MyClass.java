...
public class MyClass {
    public static void main(String[] args) {
        ...
        System.out.println(com.price); // 9000
        ...
        /*
        주문 클래스의 필드인 주문자와 주문제품은 User와 Product클래스에 강한 의존성을 가지고 있음.
        주문자와 주문제품은 반드시 User클래스와 Preoduct클래스의 객체여야 함.
        이런 관계를 가지고 있는 필드의 경우에는 클래스객체 자체를 필드로 가지도록 주문클래스를 설계할 필요가 있음
        public class Order {
            User user; // 주문자
