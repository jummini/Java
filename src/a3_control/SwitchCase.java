...
public class SwitchCase {
    public static void main(String[] args) {
        ...
        switch (day) {
            ...
            case "화", "화요일":   // 쉼표로 붙여써도 됨
                System.out.println("화요일입니다."); break;
            case "수": case "수요일":
                System.out.println("수요일입니다."); break;
            case "목":
                case "목요일": System.out.println("목요일입니다."); break;
            case "금":
                case "금요일": System.out.println("금요일입니다."); break;
            case "토":
                case "토요일": System.out.println("휴일입니다."); break;
            case "일":
                case "일요일": System.out.println("휴일입니다."); break;
