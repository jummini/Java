...
public class String2 {
    public static void main(String[] args) {
        ...
        System.out.println(str1.lastIndexOf("java")); // -1(검색 실패, 대소문자구별 함)
        System.out.println();
        ...
        // ex) Hello = 2byte*5 = 10byte, byte[]fh 바꾸면 5byte로 줄어듦
        ...
        // 한글의 문자인코등(character encoding) 방식
        // 자바가 내부적으로 사용하는 방식은 UTF-16 (2바이트)
        // 윈도우 오피스가 사용하는 방식은 EUC-KR (2바이트)
        // 가장 널리 사용되는 글로벌 표준 방식은 UTF-8 (3바이트)
        // 한글은 최소 2바이트가 필요함
        // array2의 byte[]이 15글자로 표현되는 것으로 보다 UTF-8을 사용함
        System.out.println();
...
//        System.out.println(s.indexOf("pie"));
